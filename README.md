...
| Banner video | **1280 x 320** (4:1) | Optional, in place of the still banner. Aim for under 1 MB, 5-8 seconds, about 1 Mbps, no audio track; refused past 1440 x 360, 1.5 MB, 10 seconds or 1.5 Mbps. A HandBrake preset that sets all of it is on the podcast page. Nothing is re-encoded on the server, so what you upload is what every visitor downloads - see the HandBrake recipe on the podcast page. Keep the still banner too: it is the poster. |
